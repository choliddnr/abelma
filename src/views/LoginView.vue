...
<template>
  <div class="flex flex-col items-center justify-center min-h-[70vh] px-4">
    <div class="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-4xl shadow-2xl p-8 md:p-12 border border-white/50 flex flex-col items-center gap-8 relative overflow-hidden">
