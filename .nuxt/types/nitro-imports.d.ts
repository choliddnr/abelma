declare global {
  ...
  const __buildAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.2_@b_27dd5666f0570f2656c4050f95d00806/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.2_@b_27dd5666f0570f2656c4050f95d00806/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  const _auth: typeof import('../../server/utils/auth')._auth
  const account: typeof import('../../server/utils/db/schema').account
  const alphabetChallengeProgress: typeof import('../../server/utils/db/schema').alphabetChallengeProgress
  const alphabetChallengeProgressRelations: typeof import('../../server/utils/db/schema').alphabetChallengeProgressRelations
  const analytics: typeof import('../../server/utils/db/schema').analytics
  const analyticsRelations: typeof import('../../server/utils/db/schema').analyticsRelations
  ...
  const cachedEventHandler: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  ...
  const defineAppConfig: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.2_@b_27dd5666f0570f2656c4050f95d00806/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  const defineCachedEventHandler: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/cache').defineCachedEventHandler
  const defineCachedFunction: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/cache').defineCachedFunction
  ...
  const defineNitroErrorHandler: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/error/utils').defineNitroErrorHandler
  const defineNitroPlugin: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/plugin').defineNitroPlugin
  ...
  const defineRenderHandler: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/renderer').defineRenderHandler
  ...
  const defineRouteMeta: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/meta').defineRouteMeta
  const defineTask: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/task').defineTask
  ...
  const getRouteRules: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/route-rules').getRouteRules
  ...
  const nitroPlugin: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const parseCookies: typeof import('../../node_modules/.pnpm/h3@1.15.10/node_modules/h3').parseCookies
  const profileId: typeof import('../../server/utils/db/schema').profileId
  const profileRelations: typeof import('../../server/utils/db/schema').profileRelations
  const profiles: typeof import('../../server/utils/db/schema').profiles
  ...
  const rewardRelations: typeof import('../../server/utils/db/schema').rewardRelations
  const rewards: typeof import('../../server/utils/db/schema').rewards
  const runTask: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/task').runTask
  ...
  const session: typeof import('../../server/utils/db/schema').session
  ...
  const stickerRelations: typeof import('../../server/utils/db/schema').stickerRelations
  const stickers: typeof import('../../server/utils/db/schema').stickers
  const storybookProgress: typeof import('../../server/utils/db/schema').storybookProgress
  const storybookProgressRelations: typeof import('../../server/utils/db/schema').storybookProgressRelations
  ...
  const useAppConfig: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/config').useAppConfig
  const useBase: typeof import('../../node_modules/.pnpm/h3@1.15.10/node_modules/h3').useBase
  const useEvent: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/context').useEvent
  const useImage: typeof import('../../node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_c431e0a9023360ac55e80e6ef3a3feb6/node_modules/@nuxt/image/dist/runtime/server/utils/image').useImage
  const useNitroApp: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/app').useNitroApp
  const useRuntimeConfig: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/config').useRuntimeConfig
  const useSession: typeof import('../../node_modules/.pnpm/h3@1.15.10/node_modules/h3').useSession
  const useStorage: typeof import('../../node_modules/.pnpm/nitropack@2.13.2_drizzle-or_16b7c01e6ec21a3566beb9bff4ca7476/node_modules/nitropack/dist/runtime/internal/storage').useStorage
  const user: typeof import('../../server/utils/db/schema').user
  const userId: typeof import('../../server/utils/db/schema').userId
  const userRelations: typeof import('../../server/utils/db/schema').userRelations
  const verification: typeof import('../../server/utils/db/schema').verification
...
declare global {
  ...
  // @ts-ignore
  export type { BaseRes, AlphabetChallengeProgress, ReqAlphabetChallangeProgressPut, ResAlphabetChallangeProgressGet, Reward, ReqRewardPost, ResRewardPost, ReqRewardPut, ResRewardPut, ReqRewardDelete, ResRewardDelete, ReqProfilePost, ResProfilePost } from '../../shared/types/api.d'
  import('../../shared/types/api.d')
  // @ts-ignore
  export type { DB } from '../../server/utils/db'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/Project/abelma/node_modules/.pnpm/@nuxt+nitro-server@4.4.2_@b_27dd5666f0570f2656c4050f95d00806/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/Project/abelma/node_modules/.pnpm/@nuxt+nitro-server@4.4.2_@b_27dd5666f0570f2656c4050f95d00806/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { useImage } from 'D:/Project/abelma/node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_c431e0a9023360ac55e80e6ef3a3feb6/node_modules/@nuxt/image/dist/runtime/server/utils/image';
export { _auth } from 'D:/Project/abelma/server/utils/auth';
export { db } from 'D:/Project/abelma/server/utils/db';
export { user, session, userId, account, verification, profiles, rewards, profileId, analytics, stickers, alphabetChallengeProgress, storybookProgress, userRelations, profileRelations, rewardRelations, analyticsRelations, storybookProgressRelations, stickerRelations, alphabetChallengeProgressRelations } from 'D:/Project/abelma/server/utils/db/schema';