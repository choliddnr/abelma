...
//     // ... lines 9-36 omitted for brevity, but I will include them in ReplacementContent ...
...
//         const canAfford = coins.value >= sticker.requiredScore;
...
//           cloudData.forEach((p) => {
//             if (p.stickers) {
//               currentProfileStickers.value[p.id] = p.stickers.map(
//                 (s) => s.stickerId,
//               );
//             }
//           });
