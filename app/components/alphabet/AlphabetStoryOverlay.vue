      ...
      <div v-if="currentStory"
        ...
        <div
          ...
          <template v-if="!imageError">
            <img :src="storyImageSrc" :alt="currentStory.title" class="absolute inset-0 w-full h-full object-cover"
              @error="imageError = true" :key="'img-' + currentStory.id" />
            ...
            <div
              ...
              <template v-else>
                ...
                <div class="flex flex-col gap-6">
                  ...
                  <InteractionZone ref="interactionRef" :target="currentStory.challenge.target"
                    :options="currentStory.challenge.options" :instruction="currentStory.challenge.instruction"
                    :themeColor="currentStory.themeColor" @success="onChallengeSuccess" @fail="onChallengeFail" />
                </div>
              </template>
