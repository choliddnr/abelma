  ...
  <div class="w-full max-w-2xl mx-auto px-4 py-6">
    <div class="flex items-center justify-between mb-3">
      <div class="flex flex-col">
        <span class="text-xs font-black text-indigo-500 uppercase tracking-widest">Level</span>
      ...
      <div class="flex flex-col items-end">
        ...
        <span class="text-xl font-black text-indigo-600">{{ current }} / {{ total }}</span>
      </div>
    </div>
    ...
    <div class="relative h-6 bg-slate-200/50 backdrop-blur-sm rounded-full border-2 border-white shadow-inner p-1">
      ...
      <div
        class="h-full bg-linear-to-r from-indigo-400 to-indigo-600 rounded-full transition-all duration-500 shadow-lg relative overflow-hidden"
