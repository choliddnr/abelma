...
<template>
  ...
  >
    <div v-if="activeProfileId" class="space-y-6">
      ...
      <div
        class="mt-8 pt-8 border-t border-slate-100 opacity-50 grayscale pointer-events-none"
      >
        <h4
          class="font-black text-slate-500 text-sm uppercase tracking-widest mb-4"
        >
        ...
        >
          <span class="font-bold text-slate-400"
            >Menunggu integrasi data huruf...</span
          >
        </div>
      </div>
    </div>
